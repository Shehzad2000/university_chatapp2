...
class TeacherDashboard_Card extends StatefulWidget {
  TeacherDashboard_Card({Key? key}) : super(key: key);

  @override
  State<TeacherDashboard_Card> createState() => _TeacherDashboard_CardState();
}

class _TeacherDashboard_CardState extends State<TeacherDashboard_Card> {
  ...
  void initState() {
    ...
    createGroupBloc!.add(GetGroupsByTeacherID(teacherID: "7sHbGvZERReD2qbSCPKF"));
